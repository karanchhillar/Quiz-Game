...
class QuizInterface:
    ...
    def __init__(self , quiz_brain:QuizBrain):
        ...
        self.score_label = Label(text="Score = 0",fg="white",bg=THEME_COLOR,font=("Arial",13,"italic"))
        ...
        true_image = PhotoImage(file="C:\\LOCAL DISK E\\project day 22 to\\day 34\\images\\true.png")
        self.true_button = Button(image=true_image , highlightthickness=0, command=self.true_pressed)
        self.true_button.grid(row=2,column=0)

        false_button = PhotoImage(file="C:\\LOCAL DISK E\\project day 22 to\\day 34\\images\\false.png")
